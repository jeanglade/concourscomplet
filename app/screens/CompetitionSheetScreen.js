    ...
    switch (type) {
      ...
      case 'textAthlete':
        code = (
          <View style={styles.cell}>
            <Text
              style={{color: R.colors.black, fontSize: 16, fontWeight: 'bold'}}
              numberOfLines={1}>
              {data.split('\n')[0]}
            </Text>
            <Text
              style={{color: R.colors.black, fontSize: 16}}
              numberOfLines={1}>
              {data.split('\n')[1]}
            </Text>
          </View>
...
const styles = StyleSheet.create({
  ...
  cellTextCenter: {color: R.colors.black, fontSize: 16, textAlign: 'center'},
  cellButton: {
    backgroundColor: R.colors.ffa_blue_light,
